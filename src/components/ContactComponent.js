...
class  Contact extends Component{
    ...
    validate(firstname, lastname, telnum, email, agree){
        ...
        else if(this.state.touched.firstname && firstname.length >=11){
        ...
        else if(this.state.touched.lastname && lastname.length >=11){
        ...
        if(!agree){     
            errors.agree = 'Kindly check the box';     
        }
